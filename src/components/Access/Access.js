const Access =()=>{
    return( <section id="early-access" class="relative px-6 dark:bg-darkBlue2 md:px-0">
    <div
    ...
    >
      ...
      >
        ...
        <button
          class="w-full p-3 px-6 rounded-full bg-accentCyan md:w-56 transform duration-500 hover:scale-95"
        >
